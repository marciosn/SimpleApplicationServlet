$(document).ready(function() {
    ...
    $("#listaBancoForm").submit(function(e){
           e.preventDefault();
    });
    
    //checks for the button click event
    $("#listarButton").click(function(e){
           
            //get the form data and then serialize that
            dataString = $("#listaBancoForm").serialize();
            
            //get the form data using another method 
            var countryCode = $("input#nome").val(); 
            dataString = "nome=" + countryCode;
            ...
            $.ajax({
                ...
                beforeSend: function(jqXHR, settings){
                    ...
                    $('#listarButton').attr("disabled", true);
                },
                ...
                complete: function(jqXHR, textStatus){
                    //enable the button 
                    $('#listarButton').attr("disabled", false);
                }
